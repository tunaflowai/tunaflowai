...
Channel mengubah pesan eksternal menjadi event internal. Telegram, Discord, Slack, WhatsApp Cloud, dan webhook memakai adapter masing-masing. Mode produksi harus memakai verifikasi signature, token env, rate limit, dan audit outbound.
